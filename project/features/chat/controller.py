...
from .exception import UserNotFound,RoomNotFound
...
class ChatController:
    ...
    def create_chat(self,validated_data):
        try:
         chat=self.chat_service.create_chat(validated_data.message,validated_data.sender_id,validated_data.receiver_id)
