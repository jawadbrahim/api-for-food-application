...
from .exceptions import  FoodFailedToCreate,FoodNotExist,GroupedFoodIsEmpty
...
class FoodController:
    def __init__(self):
        ...
        self.reponse_serializer=FactoryReponseSerializer.build_object()

    def create_foods(self, inputs):
        try:
            ...
            return self.reponse_serializer.serialize_create_food(food)
    ...
    def update_food(self, food_id, inputs):
        try:
            ...
            return self.reponse_serializer.serialize_update_food(updated_food)
        except FoodError as e:
           return jsonify({"error": e.to_dict()})
